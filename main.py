...
cv2.imwrite('output_image/' + input_file_name + '_output.jpg', output_image)
...
plt.savefig('output_image/' + input_file_name + '_solution.jpg', format='jpg', dpi=dpi)
plt.close(fig)
solution_image = cv2.imread('output_image/' + input_file_name + '_solution.jpg')
